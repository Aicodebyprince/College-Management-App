...
class Schedule6 extends StatelessWidget {
  const Schedule6({super.key});
...
class _ScheduleWidgetState extends State<ScheduleWidget> {
  ...
  void _updateHeaderTitle() {
    setState(() {
      headerTitle =
          highlightedIndex == 0
              ? "Today's Lectures BSC DS TY"
              : "Scheduled Lectures BSC DS TY";
    });
  }
        ...
        children: [
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              color: Color.fromARGB(255, 174, 13, 105),
